...
- #### [Ansible, What is it?](docs/ansible.md)
    ...
    - [with playbook for setting up Kubernetes - Master & Workers](docs/ansible_playbook_kubernetes.md)
    - [with playbook for setting up Kubernetes Controller - Master](docs/ansible_playbook_kubernetes_controller.md)
    - [with playbook for setting up Kubernetes Controller - Workers](docs/ansible_playbook_kubernetes_workers.md)
